...
def suma_futbol(lista_futbol):
    ...
    for elemento in lista_futbol:
        suma = suma + elemento
    return suma # return suma = 30

futbol = suma_futbol(lista_futbol)
print(futbol) # print 30
...
def suma_squash(tupla_squash):
    ...
    for elemento in tupla_squash:
        suma = suma + elemento
    return suma # return suma = 50

squash = suma_squash(tupla_squash)
print(squash) # print 50
...
plt.text(-0.90, 0.67, f"Universal = {universal}", size=10)
